...
namespace NotificationsVisualizerLibrary.Model
{
    ...
    internal class Toast : AdaptiveParentElement, IToast
    {
        ...
        //{
        //    return new Model.ObjectModelObject("ToastContent")
        //    {
        //        { "Launch", new ObjectModelString(Launch) },
        //        { "ActivationType", new ObjectModelEnum("ToastActivationType", ActivationType.ToString()) },
        //        { "Duration", new ObjectModelEnum("ToastDuration", Duration.ToString()) },
        //        { "Visual", Visual?.ConvertToObject() },
        //        { "Actions", Actions?.ConvertToObject() },
        //        { "Audio", Audio?.ConvertToObject() }
        //    };
        //}
    }
}
