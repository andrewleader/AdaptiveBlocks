...
namespace NotificationsVisualizerLibrary
{
    internal class FeatureSet
    {
        ...
        public static readonly Version CURRENT_RELEASED_OS_VERSION = new Version(10, 0, TH2, 0);
        ...
        /// <summary>
        /// Experimental next version of Adaptive Card toasts
        /// </summary>
        public bool VNEXT_AdaptiveCardToasts { get; private set; }

        [SupportedIn(RS4)]
        public bool AdaptiveCardToasts { get; private set; }
