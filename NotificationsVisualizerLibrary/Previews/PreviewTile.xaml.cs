...
namespace NotificationsVisualizerLibrary
{
    ...
    public sealed partial class PreviewTile : UserControl
    {
        ...
        private static Branding? ConvertJsonBrandingToXmlBranding(JsonTileBranding branding)
        {
            switch (branding)
            {
                case JsonTileBranding.None:
                    return Model.Enums.Branding.None;

                case JsonTileBranding.Name:
                    return Model.Enums.Branding.Name;

                case JsonTileBranding.Logo:
                    return Model.Enums.Branding.Logo;

                case JsonTileBranding.NameAndLogo:
                    return Model.Enums.Branding.NameAndLogo;
        ...
        /// </summary>
        /// <returns></returns>
        private async Task UpdateAsyncHelper()
        {
            UpdateDisplayName();
